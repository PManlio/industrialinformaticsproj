...
const eventHubsCompatibleEndpoint = "sb://ihsuprodamres010dednamespace.servicebus.windows.net/";

// Event Hub-compatible name
// az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
const eventHubsCompatiblePath = "iothub-ehub-iot-hub-pr-3698149-5be829210e";

// Primary key for the "service" policy to read messages
// az iot hub policy show --name service --query primaryKey --hub-name {your IoT Hub name}
const iotHubSasKey = "toeT1mFxvEyU3J41qmGwn2JXiQIDYYDmYRMNqN4sqyM=";
...
const connectionString = "Endpoint=sb://ihsuprodamres010dednamespace.servicebus.windows.net/;SharedAccessKeyName=iothubowner;SharedAccessKey=eMxz0g2yTpHMz+BQGQha6FHUrOFfBQgJQT4hr0A6bnU=;EntityPath=iothub-ehub-iot-hub-pr-3698149-5be829210e";
...
var printMessages = function (messages) {
  ...
  for (const message of messages) {
    ...
    msg = JSON.stringify(message.body);

    if(msg.city == "Catania") {
      console.log("Telemetry received: ");
      console.log(`${msg.variable}` + ':' + `${msg.value}`);
    }
    }
